    ...
    <>
      <div className="min-h-[70vh]">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <h1 className="font-bold text-xl text-ink mb-6">Your Cart</h1>
          {cart.map((item: any) => (
            <div key={item._id} className="space-y-3 p-4">
              <div className="card flex flex-wrap items-center justify-between gap-4">
                ...
                <div>
                  <p className="text-sm font-semibold text-ink">Rs. 4,500</p>
                </div>
                <button className="text-sm bg-red-700 text-white p-3 rounded-2xl">
                  Delete
                </button>
              </div>
            </div>
